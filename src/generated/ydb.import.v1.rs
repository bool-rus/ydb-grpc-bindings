...
pub mod import_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn import_from_s3(
            ...
            tonic::Response<super::super::ImportFromS3Response>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("Ydb.Import.V1.ImportService", "ImportFromS3"));
        ...
        pub async fn import_data(
            ...
            tonic::Response<super::super::ImportDataResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("Ydb.Import.V1.ImportService", "ImportData"));
            self.inner.unary(req, path, codec).await
        }
    }
}
