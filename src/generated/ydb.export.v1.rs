...
pub mod export_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn export_to_yt(
            ...
            tonic::Response<super::super::ExportToYtResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("Ydb.Export.V1.ExportService", "ExportToYt"));
        ...
        pub async fn export_to_s3(
            ...
            tonic::Response<super::super::ExportToS3Response>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("Ydb.Export.V1.ExportService", "ExportToS3"));
            self.inner.unary(req, path, codec).await
        }
    }
}
