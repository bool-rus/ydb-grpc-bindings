...
pub struct SchemaOperationQuotas {
    ...
    #[prost(message, repeated, tag = "1")]
    pub leaky_bucket_quotas: ::prost::alloc::vec::Vec<
        schema_operation_quotas::LeakyBucket,
    >,
}
...
pub struct GetDatabaseStatusResult {
    ...
    pub resources_kind: ::core::option::Option<
        get_database_status_result::ResourcesKind,
    >,
}
    ...
    impl State {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "PENDING_RESOURCES" => Some(Self::PendingResources),
...
pub struct AlterDatabaseRequest {
    ...
    #[prost(message, repeated, tag = "5")]
    pub computational_units_to_register: ::prost::alloc::vec::Vec<
        AllocatedComputationalUnit,
    >,
    /// Externally allocated computational units to deregister.
    #[prost(message, repeated, tag = "6")]
    pub computational_units_to_deregister: ::prost::alloc::vec::Vec<
        AllocatedComputationalUnit,
    >,
    /// Operation parameters.
...
pub struct ComputationalUnitDescription {
    ...
    pub allowed_availability_zones: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
}
#[allow(clippy::derive_partial_eq_without_eq)]
