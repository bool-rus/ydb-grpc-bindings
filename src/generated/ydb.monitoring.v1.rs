...
pub mod monitoring_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn self_check(
            ...
            tonic::Response<super::super::SelfCheckResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("Ydb.Monitoring.V1.MonitoringService", "SelfCheck"),
                );
        ...
        pub async fn node_check(
            &mut self,
            request: impl tonic::IntoRequest<super::super::NodeCheckRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::NodeCheckResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("Ydb.Monitoring.V1.MonitoringService", "NodeCheck"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
